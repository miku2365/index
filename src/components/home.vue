<template>
  <div id="home" @mousewheel="handleMouseWheel" v-swipeup="showCenter">
    ...
    <div
      ...
      <a href="http://beian.miit.gov.cn/" target="_blank" v-if="recordNumber">鄂ICP备2021019149号</a>
      <img src="0.png" class="img">
      <a href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=42900602000279" target="_blank" v-if="recordNumber">鄂公网安备42900602000279号</a>
    </div>
